                        ...
                        <tbody>
                            {dummyData.map((visitor) => (
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{visitor.alertID}</th>
                                    <td class="px-2 py-3">{visitor.message}</td>
                                    <td class="px-2 py-3">{visitor.camera}</td>
                                    <td class="px-4 py-3">{visitor.zone}</td>
                                    <td class="px-4 py-3">{visitor.time}</td>
